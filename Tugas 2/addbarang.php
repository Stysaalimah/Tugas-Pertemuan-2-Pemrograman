...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Pemesanan Tiket Kereta</a>
    ...
    <form method='post'>
        <table class='table table-bordered'>
            <tr>
                ...
                <td><input type='text' name='t' class='form-control' required maxlength="50"></td>
            </tr>

            <tr>
                <td>Stasiun Tujuan</td>
                <td><input type='text' name='stasiun_tujuan' class='form-control' required maxlength="50"></td>
            </tr>

            <tr>
                <td>Pemberangkatan</td>
                <td><input type='text' name='pemberangkatan' class='form-control' required></td>
            </tr>

            <tr>
                <td>Nama Kereta</td>
                <td><input type='text' name='nama_kereta' class='form-control' required></td>
            </tr>
            <tr>
                <td>Jenis Kereta</td>
                <td><input type='text' name='jenis_kereta' class='form-control' required></td>
            </tr>
            <tr>
                <td>Harga Tiket</td>
                <td><input type='text' name='harga_tiket' class='form-control' required></td>
            </tr>
